-- Signal Ingestion Normalization (entities implemented in stub service)
-- PostgreSQL-compatible DDL; matches fields used in tests/routes.

CREATE TABLE sin_producer (
  producer_id TEXT PRIMARY KEY,
  tenant_id TEXT NOT NULL,
  name TEXT NOT NULL,
  plane TEXT NOT NULL,                 -- edge | cloud
  owner TEXT,
  allowed_signal_kinds TEXT[] NOT NULL,
  allowed_signal_types TEXT[] NOT NULL,
  contract_versions JSONB NOT NULL,    -- {signal_type: version}
...
CREATE TABLE sin_signal (
  ...
  tenant_id TEXT NOT NULL,
  environment TEXT NOT NULL,           -- dev | prod | stage
  producer_id TEXT NOT NULL REFERENCES sin_producer(producer_id),
  signal_kind TEXT NOT NULL,           -- event | metric
