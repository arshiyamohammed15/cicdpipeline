<#
.SYNOPSIS
  ZeroUI Folder Structure Creator - Integration Environment

.DESCRIPTION
  Creates the folder structure for integration environment as per folder-business-rules.md v2.0.
  Creates tenant, product, and shared planes under {ZU_ROOT}/integration.
...
.EXAMPLE
  ...
  .\create-folder-structure-integration.ps1 -Drive "D" -ProductName "ZeroUI"
  .\create-folder-structure-integration.ps1 -ZuRoot "D:\ZeroUI"
  .\create-folder-structure-integration.ps1 -ZuRoot "D:\ZeroUI" -CompatAliases
...
Write-Host "`nCreating ZeroUI folder structure for integration environment under: $ZuRoot" -ForegroundColor Cyan
Write-Host "==========================================`n" -ForegroundColor Cyan

$errors = @()

# ============================================================================
# Create integration environment with tenant, product, and shared planes
# ============================================================================
$envPath = Join-Path $ZuRoot "integration"
$errors += if(-not (New-FolderStructure -Path $envPath -Description "integration environment")) { "integration" }

# Tenant, Product, and Shared planes
Write-Host "Creating Tenant, Product, and Shared planes for integration..." -ForegroundColor Cyan
