<#
.SYNOPSIS
  ZeroUI Folder Structure Creator - Staging Environment

.DESCRIPTION
  Creates the folder structure for staging environment as per folder-business-rules.md v2.0.
  Creates tenant, product, and shared planes under {ZU_ROOT}/staging.
...
.EXAMPLE
  ...
  .\create-folder-structure-staging.ps1 -Drive "D" -ProductName "ZeroUI"
  .\create-folder-structure-staging.ps1 -ZuRoot "D:\ZeroUI"
  .\create-folder-structure-staging.ps1 -ZuRoot "D:\ZeroUI" -CompatAliases
...
Write-Host "`nCreating ZeroUI folder structure for staging environment under: $ZuRoot" -ForegroundColor Cyan
Write-Host "==========================================`n" -ForegroundColor Cyan

$errors = @()

# ============================================================================
# Create staging environment with tenant, product, and shared planes
# ============================================================================
$envPath = Join-Path $ZuRoot "staging"
$errors += if(-not (New-FolderStructure -Path $envPath -Description "staging environment")) { "staging" }

# Tenant, Product, and Shared planes
Write-Host "Creating Tenant, Product, and Shared planes for staging..." -ForegroundColor Cyan
