...
Write-Host "[1/8] Installing core framework dependencies..." -ForegroundColor Yellow
...
Write-Host "[2/8] Installing pydantic dependencies..." -ForegroundColor Yellow
...
Write-Host "[3/8] Installing web framework..." -ForegroundColor Yellow
...
# Batch 5: Database
Write-Host "[5/8] Installing database dependencies..." -ForegroundColor Yellow
...
Write-Host "[6/8] Installing security dependencies..." -ForegroundColor Yellow
...
Write-Host "[7/8] Installing observability dependencies..." -ForegroundColor Yellow
...
Write-Host "[8/8] Installing data processing dependencies..." -ForegroundColor Yellow
...
Write-Host "[9/10] Installing caching and message queues..." -ForegroundColor Yellow
python -m pip install redis==5.0.1 hiredis==2.2.3 aiokafka==0.10.0 aio-pika==9.3.0

# Batch 10: LLM & Config
Write-Host "[10/10] Installing LLM and configuration..." -ForegroundColor Yellow
python -m pip install "openai[datalib]==1.3.0"
python -m pip install python-dotenv==1.2.1

# Batch 11: Testing
Write-Host "[11/12] Installing testing framework..." -ForegroundColor Yellow
...
Write-Host "[12/12] Installing development tools..." -ForegroundColor Yellow
