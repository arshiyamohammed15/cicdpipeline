...
This module provides a JSON file-based system to store and manage all 149
...
class ConstitutionRulesJSON:
    ...
    def _create_database(self):
        """Create new JSON database with all 149 rules."""
        try:
            ...
            logger.info("Created new JSON database with all 149 rules")
