...
def test_dual_channel_api_approve(client: TestClient) -> None:
    ...
    with patch(
        "cloud_services.product_services.mmm_engine.services.MMMService.record_dual_channel_approval"
    ) as mock_approve:
...
def test_dual_channel_api_get_status(client: TestClient) -> None:
    ...
    with patch(
        "cloud_services.product_services.mmm_engine.services.MMMService.get_dual_channel_approval_status"
    ) as mock_get:
