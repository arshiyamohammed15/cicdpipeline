...
def test_experiments_api_list(client: TestClient) -> None:
    ...
    with patch(
        ...
        with patch("cloud_services.product_services.mmm_engine.routes.list_experiments") as mock_list:
...
def test_experiments_api_create(client: TestClient) -> None:
    ...
    with patch(
        ...
        with patch("cloud_services.product_services.mmm_engine.routes.create_experiment") as mock_create:
...
def test_experiments_api_activate(client: TestClient) -> None:
    ...
    with patch(
        ...
        with patch("cloud_services.product_services.mmm_engine.routes.activate_experiment") as mock_activate:
...
def test_experiments_api_deactivate(client: TestClient) -> None:
    ...
    with patch(
        ...
        with patch(
            "cloud_services.product_services.mmm_engine.routes.deactivate_experiment"
        ) as mock_deactivate:
