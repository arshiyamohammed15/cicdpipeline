...
def test_actor_preferences_api_get(client: TestClient) -> None:
    ...
    with patch(
        ...
        with patch(
            "cloud_services.product_services.mmm_engine.routes.get_actor_preferences"
        ) as mock_get:
...
def test_actor_preferences_api_update(client: TestClient) -> None:
    ...
    with patch(
        ...
        with patch(
            "cloud_services.product_services.mmm_engine.routes.update_actor_preferences"
        ) as mock_update:
...
def test_actor_preferences_api_snooze(client: TestClient) -> None:
    ...
    with patch(
        ...
        with patch(
            "cloud_services.product_services.mmm_engine.routes.snooze_actor_preferences"
        ) as mock_snooze:
