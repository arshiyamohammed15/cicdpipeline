# Minimal example loader for merge_conflicts_and_delays
import json, pathlib

base = pathlib.Path(__file__).resolve().parents[3] / "contracts" / "merge_conflicts_and_delays" / "examples"
...
print("OK: loaded 5 examples for merge_conflicts_and_delays")
