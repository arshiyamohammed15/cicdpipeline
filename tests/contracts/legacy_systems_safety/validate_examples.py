# Minimal example loader for legacy_systems_safety
import json, pathlib

base = pathlib.Path(__file__).resolve().parents[3] / "contracts" / "legacy_systems_safety" / "examples"
...
print("OK: loaded 5 examples for legacy_systems_safety")
