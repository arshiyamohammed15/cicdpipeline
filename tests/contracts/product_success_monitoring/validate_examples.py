# Minimal example loader for product_success_monitoring
import json, pathlib

base = pathlib.Path(__file__).resolve().parents[3] / "contracts" / "product_success_monitoring" / "examples"
...
print("OK: loaded 5 examples for product_success_monitoring")
