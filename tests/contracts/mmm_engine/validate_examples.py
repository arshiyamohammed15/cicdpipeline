# Minimal example loader for mmm_engine
import json, pathlib

base = pathlib.Path(__file__).resolve().parents[3] / "contracts" / "mmm_engine" / "examples"
...
print("OK: loaded 5 examples for mmm_engine")
