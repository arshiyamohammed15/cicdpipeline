# Minimal example loader for gold_standards
import json, pathlib

base = pathlib.Path(__file__).resolve().parents[3] / "contracts" / "gold_standards" / "examples"
...
print("OK: loaded 5 examples for gold_standards")
