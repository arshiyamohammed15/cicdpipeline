"""
Test shim that proxies to the real models module under src/.
"""
...
def _load_real():
    ...
    spec = importlib.util.spec_from_file_location("signal_ingestion_normalization.models", real_path)
    if spec is None or spec.loader is None:
        raise ImportError(f"Cannot load spec for {real_path}")
    module = importlib.util.module_from_spec(spec)
    sys.modules["signal_ingestion_normalization.models"] = module
