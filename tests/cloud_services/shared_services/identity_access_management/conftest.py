"""
Test fixtures for Identity Access Management.
...
# Root conftest should have set up identity_access_management package
...
# Tests can use: from identity_access_management.main import app
