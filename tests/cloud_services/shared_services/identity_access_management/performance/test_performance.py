...
# From tests/performance/test_performance.py: go up 6 levels to project root
# tests/performance -> tests -> identity-access-management -> shared-services -> cloud_services -> src -> project_root
