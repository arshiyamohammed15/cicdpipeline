...
exports.RoiDashboardExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class RoiDashboardExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.RoiDashboardUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.roi.dashboard.refresh', () => {
            this.uiManager.updateRoiDashboardData({});
        });
...
exports.RoiDashboardExtensionInterface = RoiDashboardExtensionInterface;
class RoiDashboardTreeDataProvider {
    constructor() {
