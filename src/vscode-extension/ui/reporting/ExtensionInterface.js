...
exports.ReportingExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class ReportingExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.ReportingUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.reporting.refresh', () => {
            this.uiManager.updateReportingData({});
        });
...
exports.ReportingExtensionInterface = ReportingExtensionInterface;
class ReportingTreeDataProvider {
    constructor() {
