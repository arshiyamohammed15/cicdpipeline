...
exports.LegacySystemsSafetyExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class LegacySystemsSafetyExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.LegacySystemsSafetyUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.legacy.systems.safety.refresh', () => {
            this.uiManager.updateLegacySystemsSafetyData({});
        });
...
exports.LegacySystemsSafetyExtensionInterface = LegacySystemsSafetyExtensionInterface;
class LegacySystemsSafetyTreeDataProvider {
    constructor() {
