...
exports.FeatureDevelopmentBlindSpotsExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class FeatureDevelopmentBlindSpotsExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.FeatureDevelopmentBlindSpotsUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.feature.development.blind.spots.refresh', () => {
            this.uiManager.updateFeatureDevelopmentBlindSpotsData({});
        });
...
exports.FeatureDevelopmentBlindSpotsExtensionInterface = FeatureDevelopmentBlindSpotsExtensionInterface;
class FeatureDevelopmentBlindSpotsTreeDataProvider {
    constructor() {
