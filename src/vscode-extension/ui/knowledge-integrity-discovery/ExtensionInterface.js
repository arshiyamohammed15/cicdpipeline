...
exports.KnowledgeIntegrityDiscoveryExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class KnowledgeIntegrityDiscoveryExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.KnowledgeIntegrityDiscoveryUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.knowledge.integrity.discovery.refresh', () => {
            this.uiManager.updateKnowledgeIntegrityDiscoveryData({});
        });
...
exports.KnowledgeIntegrityDiscoveryExtensionInterface = KnowledgeIntegrityDiscoveryExtensionInterface;
class KnowledgeIntegrityDiscoveryTreeDataProvider {
    constructor() {
