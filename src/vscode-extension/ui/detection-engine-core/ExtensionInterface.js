...
exports.DetectionEngineCoreExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class DetectionEngineCoreExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.DetectionEngineCoreUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.detection.engine.core.refresh', () => {
            this.uiManager.updateDetectionEngineCoreData({});
        });
...
exports.DetectionEngineCoreExtensionInterface = DetectionEngineCoreExtensionInterface;
class DetectionEngineCoreTreeDataProvider {
    constructor() {
