...
exports.GoldStandardsExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class GoldStandardsExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.GoldStandardsUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.gold.standards.refresh', () => {
            this.uiManager.updateGoldStandardsData({});
        });
...
exports.GoldStandardsExtensionInterface = GoldStandardsExtensionInterface;
class GoldStandardsTreeDataProvider {
    constructor() {
