...
exports.IntegrationAdaptersExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class IntegrationAdaptersExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.IntegrationAdaptersUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.integration.adapters.refresh', () => {
            this.uiManager.updateIntegrationAdaptersData({});
        });
...
exports.IntegrationAdaptersExtensionInterface = IntegrationAdaptersExtensionInterface;
class IntegrationAdaptersTreeDataProvider {
    constructor() {
