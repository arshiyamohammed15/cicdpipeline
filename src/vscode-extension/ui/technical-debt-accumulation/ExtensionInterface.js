...
exports.TechnicalDebtAccumulationExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class TechnicalDebtAccumulationExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.TechnicalDebtAccumulationUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.technical.debt.accumulation.refresh', () => {
            this.uiManager.updateTechnicalDebtAccumulationData({});
        });
...
exports.TechnicalDebtAccumulationExtensionInterface = TechnicalDebtAccumulationExtensionInterface;
class TechnicalDebtAccumulationTreeDataProvider {
    constructor() {
