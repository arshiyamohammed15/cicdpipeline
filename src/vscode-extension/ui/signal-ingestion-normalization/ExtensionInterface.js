...
exports.SignalIngestionNormalizationExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class SignalIngestionNormalizationExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.SignalIngestionNormalizationUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.signal.ingestion.normalization.refresh', () => {
            this.uiManager.updateSignalIngestionNormalizationData({});
        });
...
exports.SignalIngestionNormalizationExtensionInterface = SignalIngestionNormalizationExtensionInterface;
class SignalIngestionNormalizationTreeDataProvider {
    constructor() {
