...
exports.MergeConflictsDelaysExtensionInterface = void 0;
const vscode = __importStar(require("vscode"));
const UIComponentManager_1 = require("./UIComponentManager");
class MergeConflictsDelaysExtensionInterface {
    constructor() {
        this.disposables = [];
        this.uiManager = new UIComponentManager_1.MergeConflictsDelaysUIComponentManager();
    }
    registerCommands(context) {
        ...
        const refresh = vscode.commands.registerCommand('zeroui.merge.conflicts.delays.refresh', () => {
            this.uiManager.updateMergeConflictsDelaysData({});
        });
...
exports.MergeConflictsDelaysExtensionInterface = MergeConflictsDelaysExtensionInterface;
class MergeConflictsDelaysTreeDataProvider {
    constructor() {
