...
export class ConfigManager {
    ...
    public getConfig(tableName: string, key: string, defaultValue: string = ''): string {
    ...
    public setConfig(tableName: string, key: string, value: string, description?: string): boolean {
        try {
            const fullKey = `${tableName}.${key}`;
    ...
    public getAllConfigs(tableName: string): Record<string, string> {
    ...
    public createBackup(backupName: string, description?: string): boolean {
        try {
    ...
    public getChangeHistory(limit: number = 100): string[] {
