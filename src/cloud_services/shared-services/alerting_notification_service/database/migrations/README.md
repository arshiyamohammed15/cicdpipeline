...
Or manually:
```bash
cd src/cloud-services/shared-services/alerting_notification_service/database
...
4. Run the alerting service test suite:
   `python -m pytest src/cloud-services/shared-services/alerting_notification_service/tests`.
