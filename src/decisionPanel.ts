...
export class DecisionPanel {
    ...
    private validator: ConstitutionValidator;
    private configManager: ConfigManager;

    constructor(validator: ConstitutionValidator, configManager: ConfigManager) {
    ...
    public show(): void {
        ...
        const panelTitle = this.configManager.getConfig(
            'runtime_config',
            'decision_panel_title',
            'ZEROUI 2.0 Constitution Decision Panel'
        );
    ...
    private getWebviewContent(): string {
        ...
        const statusMessage = this.configManager.getConfig(
            'runtime_config',
            'decision_panel_status_message',
            'Constitution validation detected potential issues. Review the violations below and take appropriate action.'
        );
...
<body>
    ...
    private handleValidateFile(): void {
    ...
    private handleUpdateConfig(key: string, value: string): void {
